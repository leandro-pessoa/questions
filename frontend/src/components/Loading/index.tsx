...
export const Loading = styled.div<ILoadingProps>`
	...
	div {
		// permite redefinir a grossura do loading, de acordo com a prop $borderSize
		border: ${(props) => props.$borderSize || '4px'} solid
			${(props) => props.theme.colors.secondaryBackgroundColor};
		border-radius: 50%;

		// permite redefinir a grossura do loading, de acordo com a prop $borderSize
		border-top: ${(props) => props.$borderSize || '4px'} solid
			${vars.colors.blue};

		// permite redefinir o tamanho do loading, de acordo com a prop $size
		width: ${(props) => props.$size || '40px'};
		height: ${(props) => props.$size || '40px'};

		// atribui a animação spinner à essa div
		animation: spinner 1s linear infinite;
	}

	// animação para a div ficar girando
	@keyframes spinner {
		0% {

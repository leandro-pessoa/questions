...
const Pagination = ({ totalPages, limit, fetchFunc }: IPaginationProps) => {
	...
	const renderPages = () => {
		...
		} else if (actualPage === totalPages - 1 && actualPage >= 4) { // mostra a penúltima página, 3 atrás e uma a frente
			numbersArray = numbersArray.slice(actualPage - 4, actualPage + 1)
		} else if (actualPage === totalPages && actualPage >= 5) {  // mostra a última página e 4 atrás
